...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
   ...
   // Nadeem - Removed determineDx function and optimized changePizzaSizes function per Cameron's demo in lesson #8
   //function determineDx (elem, size) {


  // Iterates through pizza elements on the page and changes their widths
  // Nadeem - Optimized changePizzaSizes function per Cameron's demo in lesson #8
...
// Nadeem - Moved following statement out of for loop to remove redundancy
...
// Nadeem - Optimized updatePositions function by moving some functionality out of loops
